            ...
            <div className="project asb">
                ...
                <div className="row">
                    <div className="col-md-8 col-md-offset-2">
                        <h3 className="subtitle">I helped developing this renovation budget planner web application. I
                            built it
                            with JavaScript framework Angular and it was optimized for use on tablets.</h3>
                    </div>
                </div>
                <div className="image">
                    <img src="/uploads/project/asb.app.jpg" alt=""/>
                </div>
            </div>
                    ...
                    <div className="row">
                        <div className="col-md-8 col-md-offset-2">
                            <ul className="numbered-detail">
                                ...
                                <li className="col-md-6">
                                    <img src="/uploads/logos/400x200/backbone.png" alt=""/>
                ...
                <section>
                    ...
                    <div className="row">
                        <div className="col-md-10 col-md-offset-1">
                            <p className="h3-css">Users can create different types of renovation projects and manage
                                their budgets.</p>
                            <p className="h3-css">They can add and edit expenses and the app keeps track of the related
                                renovation costs of the project.</p>
                        </div>
                    </div>
                </section>
